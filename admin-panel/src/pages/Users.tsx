...
const Users = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col bg-gradient-to-br from-primary to-white">
      ...
      <div className="w-full text-left border-none flex justify-between rounded-md pt-10">
        <div className="w-full flex justify-center items-center">
          <CommonTable
            fields={["SI.No", "User Name", "Email Id", "Acc Created Date"]}
            data={users ?? []}
            formatRow={(user, index) => (
              <tr
      ...
      {isSuccess && Array.isArray(users) && users.length === 0 && (
